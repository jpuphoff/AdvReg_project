...
{\centering \includegraphics[width=0.8\linewidth]{ADR_project_draft_files/figure-latex/fig2-1} 

}

\caption{OLS vs QR under random outliers}\label{fig:fig2}
\end{figure}

\begin{table}[!h]
\centering
\caption{\label{tab:table1}OLS vs Quantile Regression: Coefficients and Error Metrics under Different Error Structures}
\centering
...
\caption{Slope vs Quantile for heteroskedastic data}\label{fig:fig4}
\end{figure}
