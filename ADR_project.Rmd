...
This section presents a Monte Carlo simulation study designed to compare the performance of **Ordinary Least Squares (OLS)** and **Quantile Regression (QR)** estimators under controlled, interpretable scenarios. Our aim is to assess how both methods behave, particularly under outlier contamination.
...
- **Covariates**: $X_1 \overset{iid}{\sim} \text{Uniform}(0,10)$.
...
```{r, echo=FALSE}
plot(X1, y_clean, main = "OLS vs Multiple Quantile Regressions (Clean Data)",
...
```{r, echo=FALSE}
plot(X1, y_outliers, main = "OLS vs Quantile Regressions (Outliers Data)",
     xlab = "X1", ylab = "Y", pch = 16, cex = 0.6, col = "grey")
